...
//            TODO: Fix table styling
    ...
    private static void adminPane() {
        String secretPassword = JOptionPane
                .showInputDialog("Welcome to the Admin Login\nEnter your password: (Enter -1 to exit)");

        final String SECRET_PASSWORD = "PleaseGiveMeDistinction";
        ...
        if (!secretPassword.equals("-1")) {
            ...
            do {
                ...
                // Convert this to integer as it exits the loop on top meaning that it is an
                // integer
                ...
                if (adminUserChoiceInt == 1) {
                    ...
                    for (int i = 0; i < studentModules.length; i++) {
                        ...
                        // Get student marks
                        double studentMarks = Integer
                                .parseInt(JOptionPane.showInputDialog(studentName + " marks for " + moduleName));
    ...
    public static void main(String[] args) {
        ...
        String totalTimeTaken = String.format("%s hours %s minutes %s seconds", diffHours, diffMinutes, diffSeconds);

        JOptionPane.showMessageDialog(null, String.format("Program terminated. You have used the program for %s, Goodbye!", totalTimeTaken));
